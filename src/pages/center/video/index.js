...
export default class Index extends Component {
    ...
    _setlockToLandscapeLeft() {
        ...
        //     this.setState({ orientation });
        // });
        this.setState({ orientation: 'PORTRAITs' })
                    ...
                    <TouchableOpacity onPress={() => this._toChangeTouchState()}>
                        {this.state.paused == true ?
                            <View style={{ height: orientation == 'PORTRAIT' ? playerHeight - 50 : Platform.OS === 'android' ? AppStyles.screen_width - AppStyles.AndroidStatusBarHeight - 50 : Dimensions.get('window').width - 70 - 50, justifyContent: 'center', alignItems: 'center', }}>
                                <Image style={{ width: 50, height: 50 }} source={require('../../../assets/imgs/icon_start.png')} />
                    ...
                    {/* 底部进度条相关内容 */}
                    {
                        <View style={styles.toolBarStyle}>
                            ...
                            <TouchableOpacity onPress={() => this.play()}>
                                {this.state.paused == true ?
                                    <Image style={{ width: 25, height: 25 }} source={require('../../../assets/imgs/icon_start.png')} />
                                    : <Image style={{ width: 25, height: 25 }} source={require('../../../assets/imgs/icon_stop.png')} />}
                            </TouchableOpacity>
                            ...
                            </View>
                            {
                                orientation == 'PORTRAIT' ?
                                    <TouchableOpacity onPress={() => this._setlockToLandscapeLeft()}>
                                        <Image style={{ width: 25, height: 25 }} source={require('../../../assets/imgs/icon_screen_a.png')} />
                                    </TouchableOpacity> :
                                    <TouchableOpacity onPress={() => this._setlockToPortrait()}>
                                        <Image style={{ width: 25, height: 25 }} source={require('../../../assets/imgs/icon_screen_b.png')} />
                                    </TouchableOpacity>
                            }
